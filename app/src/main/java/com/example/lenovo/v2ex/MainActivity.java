...
//            public void run() {
//                //测试用
//                String data = InternetUtils.getHttpContent("https://www.v2ex.com/?tab=tech");
//                new GetFromHtml().get(data);
//            }
//        }).start();
...
//        });
        ...
        list = new ArrayList<>();
        Fragment hotTopics = new HotTopics();
        Fragment newTopics = new NewTopics();
        Fragment techTopics = new TechTopics();
        list.add(hotTopics);
        list.add(newTopics);
        list.add(techTopics);
        ViewPager viewPager = (ViewPager)findViewById(R.id.viewPager);
        TopicFragmentPagerAdapter adapter = new TopicFragmentPagerAdapter(getSupportFragmentManager(),list);
